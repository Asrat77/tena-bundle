class DoctorsController < ApplicationController
  ...
  def create
    @doctor = TenaDcms::Doctor.new(doctor_params)
  ...
  def set_doctor
    @doctor = TenaDcms::Doctor.find(params[:id])
  end

  def doctor_params
    params.require(:doctor).permit(:name, :phone_number, :email)
  end
end
